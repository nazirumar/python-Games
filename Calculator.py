...
class  MainWindow(qtw.QWidget):
    def __init__(self):
        ...
        self.setWindowIcon(QtGui.QIcon('DDDDk.png'))
    ...
    def num_press(self, key_number):
        self.tem_nums.append(key_number)
        temp_string=''.join(self.tem_nums)
        if self.fin_nums:
    ...
    def func_result(self):
        fin_string = ''.join(self.fin_nums) + ''.join(self.tem_nums)
...
mw = MainWindow()
mw.setStyleSheet("background-color: black; color:white;")
